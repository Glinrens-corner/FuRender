...
namespace furender {
  ...
  class BaseWidget {
    ...
    public:
      ...
      virtual std::optional<std::reference_wrapper<const std::string>>
        get_nth_selector_address(std::size_t i) = 0;

      widget_id_t get_widget_id() const { return this->widget_id_; }
  };
  ...
  /** @brief WidgetClass, that knows its Widgettype and the return type of the
   * render function
   *
   */
   ...
   *
   * the final Widget class needs to override accept() such that is calls
   * visitor.render(*this);
   ...
   *  * implement args_tuple_t as a std::tuple<arg_ts...> of the Selector
   * arguments
  ...
  template <WidgetType widget_type_,
    ...
    class return_t_,
    class... arg_ts_>
  class WidgetImpl<widget_type_,
    render_fn_t_,
    return_t_(Context<widget_type_>&, const arg_ts_&...)>
    final : public Widget<widget_type_, return_t_> {
    public:
    ...
    public:
      WidgetImpl(render_fn_t_ render_fn,
      ...
      constexpr static WidgetType get_widget_type() { return widget_type_; }
      ...
      std::optional<std::reference_wrapper<const std::string>>
        get_nth_selector_address(std::size_t i) final override {
    ...
    private:
      ...
      std::optional<std::reference_wrapper<const std::string>>
        get_nth_selector_address_i(std::size_t i) {
    ...
    private:
      static_assert(std::is_same_v<std::invoke_result_t<render_fn_t_,
                                     Context<widget_type_>&,
                                     const arg_ts_&...>,
                      return_t_>,
        "the render_function has to comfort to the render_function_signature");
  };
  ...
  namespace detail {
    ...
    class WidgetBuilderStage2 {
      ...
      public:
        WidgetBuilderStage2(
          render_fn_t_ fn, std::tuple<Selector<arg_ts_>...> selectors)
          : fn_(std::move(fn)),
            selectors_(std::move(selectors)) {}

        std::shared_ptr<WidgetImpl<widget_type_,
          render_fn_t_,
          return_t_(Context<widget_type_>&, const arg_ts_&...)>>
          make_shared() {
          return std::make_shared<WidgetImpl<widget_type_, render_fn_t_,
            return_t_(Context<widget_type_>&, const arg_ts_&...)>>(
            std::move(this->fn_), std::move(this->selectors_),
            create_widget_id());
        }
    };
      ...
      public:
        ...
        WidgetBuilderStage2<widget_type_,
          ...
          using return_t = typename std::invoke_result<render_fn_t,
            Context<widget_type_>&, const arg_ts_&...>::type;
          return WidgetBuilderStage2<widget_type_, render_fn_t, return_t,
            arg_ts_...>(std::move(fn), std::move(this->selectors_));
        }
    };
  ...
  detail::WidgetBuilderStage1<widget_type_, arg_ts_...>
    ...
    return detail::WidgetBuilderStage1<widget_type_, arg_ts_...>(
      std::move(selectors)...);
  }
