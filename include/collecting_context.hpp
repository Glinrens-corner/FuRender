...
namespace furender{
  ...
  /** @brief subset of data in CollectionContext that is needed to create a new WidgetInstanceData struct.
   *
   */
  ...
  struct CollectingContext{
  public:
    client_instance_id_t client_id{}; // the Client to which to dispatch the commands.
