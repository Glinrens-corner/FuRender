...
namespace furender {
  /** @brief Class that communicates the path and elementtype of a StateSlice to
   * a Widget
   *
   *  @tparam selected_t_ type of the value of the  selected state, must be
  ...
  class Selector {
    ...
    private:
      static_assert(std::is_default_constructible<selected_t_>::value,
